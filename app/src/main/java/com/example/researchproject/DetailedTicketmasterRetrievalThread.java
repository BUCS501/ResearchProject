...
import static com.example.researchproject.BuildConfig.TICKETMASTER_API_KEY;
...
public class DetailedTicketmasterRetrievalThread extends Thread {
    ...
    public DetailedTicketmasterRetrievalThread(DetailedEventActivity detailedEventActivity) {
    ...
    private void getEvent(String id) throws IOException, JSONException, org.json.simple.parser.ParseException {
        URL url = new URL(BASE_URL + id + "?apikey=" + TICKETMASTER_API_KEY);
